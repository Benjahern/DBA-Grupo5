    ...
    public void logContainerStats() {
        ...
        for (Instance instance : runningInstances) {
            try {
                ...
                ResultCallbackTemplate<StatsCmd, Statistics> callback = new ResultCallbackTemplate<StatsCmd, Statistics>() {
                    @Override
                    public void onNext(Statistics stats) {
                        if (stats != null) {
                            ...
                            if (stats.getCpuStats() != null && stats.getCpuStats().getCpuUsage() != null && stats.getPreCpuStats() != null) {
                                ...
                                int onlineCpus = stats.getCpuStats().getOnlineCpus();
                                if (systemCpuDelta > 0 && cpuDelta > 0) {
                                    cpuUsage = (double) cpuDelta / (double) systemCpuDelta * onlineCpus * 100.0;
                                }
                            }
