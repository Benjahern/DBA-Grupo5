...
import BandwidthReport from "../views/BandwidthReport.vue";
...
const routes = [
  ...
  { path: '/bandwidth', name: 'bandwidth', component: BandwidthReport, meta: { title: 'Ancho de Banda', requiresAuth: true } }
];
