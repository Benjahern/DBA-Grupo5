  ...
  <div class="modal-backdrop" @click.self="emitClose">
    <div class="modal-card">
      ...
      <div class="modal-body">
        <p>¿Estás seguro de que deseas eliminar la región <strong>{{ region?.Name }}</strong>?</p>
...
const handleDelete = async () => {
  ...
  try {
    await api.delete(`/api/regions/${props.region.region_id}`);
    ...
    if (err.response && err.response.data) {
      error.value = typeof err.response.data === 'string' ? err.response.data : 'Error al eliminar la región.';
    } else {
      error.value = 'No se pudo eliminar la región. Puede que tenga instancias asociadas.';
    }
